...
class SubscriptionsViewModel @Inject constructor(
     ...
     */
    private fun initializeTabsIfNeeded() {
        if(selectedTab == null){
     ...
     */
    private fun trackPurchaseAttempt(productDetails: ProductDetails) {
        segmentAnalyticsUseCases.track(
     ...
     */
    private fun trackPurchaseError(productDetails: ProductDetails, error: String) {
        segmentAnalyticsUseCases.track(
